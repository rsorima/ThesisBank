...
<html>
    ...
    <body class="hold-transition skin-green sidebar-mini fixed">
                ...
                <div class="row">
                        <div class = "col-md-12">
                            <div class="box box-info border-blue">
                                ...
                                <div class="box-body">
                                    <table id="tblProgramHead" class="table table-bordered table-hover table-custom">
                                        <thead>
                                            <tr>
                ...
                <form id="form-user">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Add Program Head</h4>   
                        </div>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" id="btnSubmit">Add Program Head</button> 
                ...
                <form id="form-edituser">
                    <div class="modal-content">
                        ...
                        <div class = "modal-body">
                            ...
                            <div class="form-group">
                                <label>Password:</label> 
                                <input type="password" class="form-control" id="EPassword" disable>
        ...
        <script src="js/programhead.js"></script>
