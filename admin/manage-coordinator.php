                ...
                <div class="row">
                        <div class = "col-md-12">
                            <div class="box box-info border-blue">
                                ...
                                <div class="box-body">
                                    <table id="tblCoordinator" class="table table-bordered table-hover table-custom">
                                        <thead>
                                            <tr>
                    ...
                    <form id="form-user">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary" id="btnSubmit">Add Coordinator</button> 
