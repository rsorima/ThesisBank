$(document).ready (function() {
	...
	$("#btnSubmit").click(function(){
		...
		if(success==5){
			$.ajax({
				...
				url: "php/insert-programhead.php",
				success: function(result){
					...
					$("#form-user").hide();
					$("#tblProgramHead").DataTable().ajax.reload();
					})
				}
			})
		}
	...
	$(document).on("click","#btnDelete", function(){
		...
		swal({
            title: "Are you sure you want to delete this Program Head?",
            type: "error",
            ...
            $.ajax({
                ...
                url: "php/delete-ProgramHead.php",
		...
		$("#btnUpdate").click(function(){
			...
			if(success==4){
				$.ajax({
					...
					url: "php/update-programhead.php",
					success: function(result){
						alert(result);
