                ...
                <div class="row">
                        <div class = "col-md-12">
                            <div class="box box-info border-blue">
                                ...
                                <div class="box-body">
                                    <table id="tblLibrarian" class="table table-bordered table-hover table-custom">
                                        <thead>
                                            <tr>
                ...
                <form id="form-user">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" id="btnSubmit">Add Librarian</button> 
            ...
            <div class="modal-dialog modal-md">
                <form id="form-edituser">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal"> &times; </button>
                            <h4 class="modal-title">Edit Librarian</h4>   
                        </div>
                        <div class = "modal-body">
                            <div class="form-group">            
                                <label>First name:</label>
