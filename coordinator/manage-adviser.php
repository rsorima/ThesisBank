<?php
    ...
    if(isset($_POST['addUser'])) {
        ...
        $stmt->execute();
        header("location:manage-adviser.php");
    }
                ...
                <div class="row">
                        <div class = "col-md-12">
                            <div class="box box-info border-blue">
                                ...
                                <div class="box-body">
                                    <table id="tblAdviser" class="table table-bordered table-hover table-custom">
                                        <thead>
                                            <tr>
                                        ...
                                        <?php  
                                            ...
                                            {  
                                               ...
                                               <tr>  
                                                    ...
                                                    <td>'.$row["code"].'</td>  
                                                    <td>'.$status.'</td>  
                                                    <td><button class="btn btn-xs btn-primary btn-table" id="btnEdit" userid='.$row[0].' fname='.$row["Fname"].' lname='.$row["Lname"].' uname='.$row["username"].' pword='.$row["password"].' style="width: 65px;" >Edit</button><a href="php/delete-adviser.php?userid='.$row[0].'" class="btn btn-xs btn-danger btn-table" id="btnDelete" userid='.$row[0].' style="width: 65px;">Delete</a></td>  
                                               </tr>  
                                               ';  
                                            }  
                                        ?>
                                ...
                                <div class="box-footer">
                                    ...
                                    <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#modalAddUser"> <span class="fa fa-md fa-user-plus"></span> Add Adviser </button>
                ...
                <form id="form-user" method="post">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <input type="submit" class="btn btn-primary" id="btnSubmit" name="addUser" value="Add Adviser">
                    ...
                    <form id="form-edituser" method="post">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="submit" class="btn btn-primary" id="btnUpdate" name="editUser" value="Edit"> 
                                <button type="button" class="btn btn-default" id="btnAddClose" data-dismiss="modal">Close</button>                                             
                            </div>
                        </div>
                    </form>
