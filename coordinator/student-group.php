                        ...
                        <div class = "col-md-12">
                            <div class="box box-info border-blue">
                                        ...
                                        <?php
                                            ...
                                            {  
                                               ...
                                               <tr>  
                                                    ...
                                                    <td>'.$row["code"].'</td>  
                                                    <td>'.$status.'</td>  
                                                    <td><button class="btn btn-xs btn-primary btn-table" id="btnEdit" userid='.$row[0].' fname='.$row["Fname"].' lname='.$row["Lname"].' uname='.$row["username"].' pword='.$row["password"].' style="width: 65px !important;" >Edit</button><a href="php/delete-student.php?userid='.$row[0].'" class="btn btn-xs btn-danger btn-table" id="btnDelete" userid='.$row[0].' style="width: 65px;">Delete</a></td>  
                                               </tr>  
                                               ';  
                                            }  
                                        ?>
                                ...
                                <div class="box-footer">
                                    ...
                                    <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#modalAddUser"> <span class="fa fa-md fa-user-plus"></span> Add Student </button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class = "modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" id="cbShowPassword2" />Show password
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input type="submit" class="btn btn-primary" id="btnSubmit" name="addUser" value="Submit">
                    ...
                    <form id="form-edituser" method="post">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="submit" class="btn btn-primary" id="btnUpdate" name="editUser" value="Update">
                                <button type="button" class="btn btn-default" id="btnAddClose" data-dismiss="modal">Close</button>                                             
                            </div>
                        </div>
                    </form>
