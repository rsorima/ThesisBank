...
$get_group = "SELECT g.group_name, g.branchid as branch_id, d.report_file, d.report_type, d.date_created FROM groups g INNER JOIN documentation d on g.group_id = d.group_id WHERE branchid = '$branchid' AND coordinator_id != 0";
