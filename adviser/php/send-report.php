...
$getReports = "SELECT group_id, adviser_id, report_file, report_type from reports where report_id = '$reportId'";
$resultReports = mysqli_query($con, $getReports);
...
$addReport = "INSERT INTO reports (group_id, adviser_id, coordinator_id, report_file, report_type) VALUES ('$groupId','$adviserId','$coordinatorId','$reportFile','$reportType')";
